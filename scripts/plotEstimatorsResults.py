...
# rHartley_fb_transfo = rHartley_fb[0].inv() * rHartley_fb
# rHartley_fb_matchVanyte_init = rVanyte[0] * rHartley_fb_transfo
# posHartley_fb_transfo = rHartley_fb[0].apply(posHartley_fb - posHartley_fb[0], inverse = True)
# posHartley_fb_matchVanyte_init = posVanyte[0] + rVanyte[0].apply(posHartley_fb_transfo)
# posHartley_fb = posHartley_fb_matchVanyte_init

# euler_angles_Hartley = rHartley_fb_matchVanyte_init.as_euler('xyz')
euler_angles_Hartley = continuous_euler(euler_angles_Hartley)
...
dfHartley = dfHartley.truncate(after=999)

txtOutput = f'{path_to_project}/output_data/formattedHartleyTraj.txt'
dfHartley.to_csv(txtOutput, header=None, index=None, sep=' ')
